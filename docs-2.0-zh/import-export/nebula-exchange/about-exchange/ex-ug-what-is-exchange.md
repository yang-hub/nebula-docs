...
Exchange 有社区版和企业版两个系列，二者功能不同。社区版在 [GitHub](https://github.com/vesoft-inc/nebula-exchange) 开源开发，企业版属于{{nebula.name}}企业套餐。详情参见[版本对比](https://yueshu.com.cn/pricing/)。
