...
* [SUBMIT JOB BALANCE](../synchronization-and-migration/2.balance-syntax.md)
  ...
  |`SUBMIT JOB BALANCE DATA IN ZONE REMOVE` | Starts a job to clear the partitions on specified Storage services in zones in the current graph space.|
